...
- (IBAction)changeToTable:(id)sender {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    EMCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    
    Doctor *doctor = self.doctors [indexPath.row];
    cell.doctorsImg.image = [UIImage imageNamed:doctor.faceOfDoctor];
